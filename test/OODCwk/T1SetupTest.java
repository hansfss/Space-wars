...
public class T1SetupTest {
    ...
    @Test
    public void detailsOfSS7() {
        String str = game.getForceDetails("SS7");
        String[] target = {"SS7","Explorer","120","65","In dock","4","5"};
        boolean result = containsText(str, target);
        assertTrue(result);
    }

    @Test
    public void detailsOfIW10() {
        String str = game.getForceDetails("IW10");
        String[] target = {"IW1","Flyers","200","100","In dock","5"};
        boolean result = containsText(str, target);
        assertTrue(result);
    }
    @Test
